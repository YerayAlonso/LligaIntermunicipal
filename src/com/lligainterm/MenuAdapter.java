...
public class MenuAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        return getItem(position) instanceof Fase ? 0 : 1;
    }
    ...
    public boolean isEnabled(int position) {
        return getItem(position) instanceof Fase;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item instanceof Category) {
            ...
            tv.setText(((Fase) item).mTitle);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                tv.setCompoundDrawablesRelativeWithIntrinsicBounds(((Fase) item).mIconRes, 0, 0, 0);
            } else {
                tv.setCompoundDrawablesWithIntrinsicBounds(((Fase) item).mIconRes, 0, 0, 0);
            }
        }
