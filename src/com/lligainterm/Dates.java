...
public class Dates {
	...
	public static final Date t1213[] = {
		
		//1a Fase 2012 - 2013
		new GregorianCalendar(2012, 10, 5).getTime(),
		new GregorianCalendar(2012, 10, 12).getTime(),
		new GregorianCalendar(2012, 10, 19).getTime(),
		new GregorianCalendar(2012, 10, 26).getTime(),
		new GregorianCalendar(2012, 11, 10).getTime(),
		new GregorianCalendar(2012, 11, 17).getTime(),
		...
		//2a Fase 2012 - 2013
		/*,
		new GregorianCalendar(2013, 3, 15).getTime(),
		new GregorianCalendar(2013, 3, 22).getTime(),
		new GregorianCalendar(2013, 3, 29).getTime(),
		new GregorianCalendar(2013, 4, 6).getTime(),
		new GregorianCalendar(2013, 4, 13).getTime()/**/
	};
	...
	public static final Date t1314[] = {
		...
		new GregorianCalendar(2013, 11, 16).getTime(),
		new GregorianCalendar(2014, 0, 13).getTime(),
		new GregorianCalendar(2014, 0, 20).getTime(),
		new GregorianCalendar(2014, 0, 27).getTime(),
		new GregorianCalendar(2014, 1, 3).getTime()

		//2a Fase 2012 - 2013
		/*,
		new GregorianCalendar(2014, x, x).getTime()/**/
